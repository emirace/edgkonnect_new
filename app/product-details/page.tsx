...
export const metadata: Metadata = {
  ...
  description:
    "Complete product overview of Edgkonnect MCPPT-1-XC Push-to-Talk system. Learn about device specifications, mobile app, web admin, and dispatcher features.",
  openGraph: {
    title: "MCPPT-1-XC Product Details",
    description:
      "The most Naira-friendly and effective PTT solution with crystal-clear audio, GPS tracking, and mission-critical reliability.",
  },
};
