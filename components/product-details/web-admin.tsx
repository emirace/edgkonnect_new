...
export function WebAdmin() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-[#05204A] to-[#0a3d6b]">
          ...
          <div className="order-1 lg:order-2">
            <div className="mb-8">
              ...
              <p className="text-lg text-[#CAF0F8]/80 leading-relaxed">
                Centralized administration platform for provisioning and
                managing all your devices. Supports both manual and automated
                (SOAP protocol) activation with user-friendly interface.
              </p>
            </div>
