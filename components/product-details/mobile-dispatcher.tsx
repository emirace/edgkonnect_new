      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="mb-8">
              <span className="inline-block px-4 py-2 rounded-full bg-[#0080E2]/10 border border-[#0080E2]/30 mb-4">
                <span className="text-sm font-semibold text-[#0080E2] tracking-widest uppercase">
                  Mobile Solution
                </span>
              </span>
              ...
              <p className="text-lg text-[#05204A]/70 leading-relaxed">
                Full-featured Android dispatcher compatible with any 2.3+
                device. Works seamlessly over 2G, 3G, 4G/LTE, WiFi, and wired
                connections.
              </p>
            </div>
              ...
              <ul className="space-y-3">
                {mobileFeatures.map((feature, idx) => (
                  <li key={idx} className="flex items-center gap-3">
                    <div className="shrink-0 w-5 h-5 rounded-full bg-linear-to-br from-[#0080E2] to-[#45D6A8] flex items-center justify-center">
                      <svg
          ...
          <div className="relative">
            <div className="bg-linear-to-br from-[#05204A]/10 to-[#0080E2]/5 rounded-2xl p-8 border border-[#05204A]/10">
              <img
                src="/mobile.png"
